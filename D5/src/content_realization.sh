...
python ./infolm_eval.py /D5/data/model_devtest/ /D5/outputs/D5_devtest/LLR_devtest/ 1 infolm_output_LLR_devtest.csv
python ./infolm_eval.py /D5/data/model_devtest/ /D5/outputs/D5_devtest/lexrank_compressed_devtest/ 2 infolm_output_sumbasic_devtest.csv
python ./infolm_eval.py /D5/data/model_devtest/ /D5/outputs/D5_devtest/sumbasic_devtest/ 3 infolm_output_LexRank_devtest.csv
python ./pearson.py /D5/data/model_devtest/ /D5/outputs/D5_devtest/LLR_devtest/ 1 pearson_output_LLR_devtest.csv
python ./pearson.py /D5/data/model_devtest/ /D5/outputs/D5_devtest/sumbasic_devtest/ 2 pearson_output_sumbasic_devtest.csv
python ./pearson.py /D5/data/model_devtest/ /D5/outputs/D5_devtest/lexrank_compressed_devtest/ 3 pearson_output_lexrank_devtest.csv
